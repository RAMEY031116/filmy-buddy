...
st.title("FilmyBuddy 🎬")
st.markdown("Track your movies/shows, get recommendations, and see latest releases!")
...
if not df.empty:
    ...
    if tmdb_api_key:
        ...
        try:
            ...
            latest_movies = [m["title"] for m in response.get("results", [])][:5]
